<script lang="ts">
	...
	// bg-card/border-border surface, p-1 per 07-UI-SPEC.md's "Styling
	// contract"). max-h-80 + overflow-y-auto is the height cap the E1/E3
	// overflow backstop truths require: a long menu (many webspaces, many
	// unconfigured plugin types) scrolls inside the menu rather than
	// growing the dropdown past the viewport.
