...
- [x] **SRC-05**: User can add a Google Drive folder as a source using their own Google OAuth client (bring-your-own credentials via env refs), with incremental sync, Workspace-doc export previews, and deep links to the Drive web UI
- [x] **SRC-06**: The Google Drive plugin is developed out-of-repo against the published contract and installed through the external-plugin path — proving a third party can ship a working untrusted plugin end to end
...
| SRC-05 | Phase 14 | Complete |
| SRC-06 | Phase 14 | Complete |
