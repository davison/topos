...
| Capability | Decision | Reason |
|---|---|---|
| Enable PVR — `PUT .../private-vulnerability-reporting` | INTEGRATE | Success criterion 2 — `SECURITY.md` points at the "Report a vulnerability" button, which does not exist until this is enabled. |
