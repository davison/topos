...
- [ ] **Phase 12: Filesystem Source** - A local or network folder becomes a source; its binary doubles as the external-path rehearsal before Google Drive (UAT gap closure in progress — G-12-1/G-12-3)
