...
// for the live-UAT-found gap (Quick task 260805-j98 follow-up): the detail
// pane's stream/list scrollbar was restyled thin and theme-matched via
...
// self-contained document (the rendition's own themeStyle) — so an email
// rendition kept the browser-default scrollbar until this rule was added
// directly here.
